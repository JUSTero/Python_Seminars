...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("Polinomyal1.txt", create_str(koef1))
write_file("Polinomyal2.txt", create_str(koef2))

# нахождение суммы многочлена

with open('Polinomyal1.txt', 'r') as data:
    st1 = data.readlines()
with open('Polinomyal2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("PolinomyalsRes.txt", create_str(lst_new))
with open('PolinomyalsRes.txt', 'r') as data:
    st3 = data.readlines()
